...
- **Language:** Python 3
- **Data Manipulation & Cleaning:** `pandas` (heavy use of `melt`, `pivot_table`, `groupby`), `numpy`
...
TFG/
 |-- data/
 |   |-- raw/                # Raw genomic and clinical data matrices
 |   |-- processed/          # Cleaned and normalized DataFrames
 |-- notebooks/              # Jupyter notebooks containing the analysis pipeline
 |-- results/                # Output visualizations (Seaborn plots) and normalized tables
 |-- scripts/                # Python scripts for API extraction and data wrangling
